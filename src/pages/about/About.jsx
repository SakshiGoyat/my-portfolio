...
import "./about.scss";
import my2 from "../../assets/images/my_image.jpeg";
          ...
          <div>
            ...
            <div className="about__me switch__bg">
              <div className="about__me-image">
                <img src={my2} alt="image" className="about-image" />
              </div>
            </div>
            <div>
              <Fade>
                <p>
                  I am a passionate Full Stack Developer who loves to explore
                  new technologies and build scalable applications. Although I
